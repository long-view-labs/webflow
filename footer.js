...
(function () {
  function loadFilterSearch() {
    ...
    script.src =
      "https://cdn.jsdelivr.net/gh/long-view-labs/webflow@v2.620.48/hero-filter-search.js";
    script.async = true;
...
(function () {
  ...
  function loadScriptsOnInteraction() {
    ...
    updateCopyrightYear();
    loadScript(
      "https://cdn.jsdelivr.net/gh/long-view-labs/webflow@v2.620.48/timed-tabs.js",
    );
  }

  function loadNavbarScripts() {
    loadScript(
      "https://cdn.jsdelivr.net/gh/long-view-labs/webflow@v2.620.48/navbar.js",
    );
  }
